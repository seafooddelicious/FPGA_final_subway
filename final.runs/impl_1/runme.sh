...
HD_PWD='C:/Users/603/Desktop/FPGA/final/final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SUBWAY.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SUBWAY.tcl -notrace
